...
/**
 * PRO upgrade promotion, shown ONLY on the Estimate settings screen: a
...
final class ProUpsell
{
    ...
    private function url(): string
    {
         ...
         *
         * @param string $url Default the Estimate PRO pricing page.
         */
    ...
    private function priceLabel(): string
    {
        ...
        if ($this->isPolish() && ! empty($d['price_pln'])) {
            ...
            return sprintf(__('od %d zł/rok', 'plogins-estimate'), (int) $d['price_pln']);
        }
    ...
    public function banner(): void
    {
        ...
        <div class="estimate-pro-banner" role="note">
            ...
            <a class="button button-primary estimate-pro-banner__cta" href="<?php echo esc_url($this->url()); ?>" target="_blank" rel="noopener noreferrer">
                <?php esc_html_e('Upgrade to PRO', 'plogins-estimate'); ?>
            </a>
    ...
    public function aside(): void
    {
        ...
        <aside class="estimate-card estimate-pro-aside" aria-labelledby="estimate-pro-aside-h">
            ...
            <?php if ($price !== '') : ?>
                <p class="estimate-pro-aside__price"><?php echo esc_html($price); ?> · <?php esc_html_e('one licence, every PRO feature', 'plogins-estimate'); ?></p>
            <?php endif; ?>
        </aside>
        <?php
    }
